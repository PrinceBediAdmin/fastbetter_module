    ...
    <NavigationContainer>
      {isLoading ? (
        ...
        <Stack.Navigator initialRouteName={'Fasting'}>
          ...
          <Stack.Screen name="TrackFastingScreen" options={disabledHeader} component={TrackFastingScreen} />
          <Stack.Screen name="TrackWorkoutScreen" options={disabledHeader} component={TrackWorkoutScreen} />
          <Stack.Screen name="TrackCaloriesScreen" options={disabledHeader} component={TrackCaloriesScreen} />
          <Stack.Screen name="TrackWaterScreen" options={disabledHeader} component={TrackWaterScreen} />
          <Stack.Screen name="TrackHealthScreen" options={disabledHeader} component={TrackHealthScreen} />
        </Stack.Navigator>
      )}
    </NavigationContainer>
  );
