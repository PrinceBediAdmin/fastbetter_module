    ...
    const DailyView = () => {
        return <ScrollView style={{ flex: 1, width: '100%' }} showsVerticalScrollIndicator={false}>
            <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 24, fontWeight: "700", fontFamily: 'Larken', marginHorizontal: 30, color: '#FE7701', lineHeight: 25.44 }}>{"18,950 ml "}
                    <Text style={{ color: '#000', fontWeight: "400", }}>{"consumed"}</Text>
                </Text>
                <Text style={{ fontSize: 12, fontWeight: "400", lineHeight: 14.18, marginHorizontal: 30, color: '#18192B' }}>{"Data from your water intake logs "}</Text>
                        ...
                        <View>
                            {
                                index == ChartData?.datasets[0]?.data.length - 2 && <ImageBackground key={index}
                                    ...
                                    <Text style={{ fontSize: 16, color: '#000' , fontFamily:'Larken' , fontWeight:'700' , fontStyle:'italic' }}>{indexData+" ml"}</Text>
                                </ImageBackground>
                            }
                        </View>
                ...
                <View className={`flex bg-white px-5 py-3 rounded-3xl mb-2 border border-gray-100 shadow-sm shadow-slate-300 sha overflow-hidden`} style={{ marginHorizontal: 30, marginTop: 30 }}>
                    <View className="flex flex-row justify-between items-center">
                        <View className="flex flex-row gap-x-2 justify-center items-center">
                            <Image source={require('../../../assets/afterscreen/home/water.png')} className="h-auto w-auto" />
                            <View className="flex justify-start items-start">
                                <Text className="text-black text-base font-semibold leading-[0.1]">Consumption</Text>
                        ...
                        <View className='flex flex-row items-center gap-x-2'>
                            <View className='flex flex-row items-center'>
                                <View>
                                    ...
                                    <Text className='text-xs text-black font-[700] -mt-0.5'>2,200 ml</Text>
                                </View>
                            </View>

                            <View className='flex flex-row items-center'>
                                <View className='w-[1.5px] h-[20px] bg-[#000]' style={{ marginRight: 8 }} />
                                <View>
                                    <Text className='text-xs'>Required</Text>
                                    <Text className='text-xs text-black font-[700] -mt-0.5'>2,500 ml</Text>
                                </View>
                            </View>
                        </View>
                        <View className="flex justify-center items-start align-middle">
                            <Text className='text-xs'>Recommended</Text>
                            <Text className='text-xs text-black font-[700] -mt-0.5' style={{ textAlign: 'right', width: 82 }}>5,000 ml</Text>
                        </View>
                    </View>

                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        <View style={{ alignItems: 'center', marginTop: 16, flexDirection: 'row', gap: 8, }}>
                            {
                                glassesData.map((item, index) => {
                                    return (
                                        <Image source={!item.isActive ? glasses : water_glasses} style={{ width: 16, height: 24 }} />
                                    )
                                })
                            }
                        </View>
        ...
        return (
            <View>
                ...
                <LinearGradient
                    ...
                    style={{ width: 40, height: 176, borderRadius: 8, padding: 4, gap: 3, borderWidth: 1, borderColor: '#FFF2EA', justifyContent: "flex-end" }}>
                    {/* {
                        item.value != 0 && item.value !== 2 && <View style={{ flex: 1, }} />
                    } */}
                    <View style={{ backgroundColor: "#FF9950", height: item.value, borderRadius: 8, }} />
                </LinearGradient>
    ...
    const WeeklyView = () => {
        return <ScrollView style={{ flex: 1, width: '100%' }} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
            <View style={{ flex: 1 }}>
                ...
                <View className={`flex bg-white px-5 py-3 rounded-3xl mb-2 border border-gray-100 shadow-lg shadow-gray-100 sha overflow-hidden-`} style={{ marginHorizontal: 30, marginTop: 30 }}>
                    <View className="flex flex-row justify-between items-center">
                        <View className="flex flex-row gap-x-2 justify-center items-center">
                            <Image source={require('../../../assets/afterscreen/home/water.png')} className="h-auto w-auto" />
                            <View className="flex justify-start items-start" style={{ paddingLeft: 10 }}>
                                <Text className="text-black text-base font-semibold leading-[0.1]">Consumption</Text>
                                <Text className="text-gray-600 text-[10px] leading-[0.1] -mt-1">Sun, 15th Nov</Text>
                            </View>
                        </View>
                    ...
                    <View className='flex flex-row items-center align-middle justify-between mt-6 mb-3'>
                        <View className='flex flex-row items-center gap-x-2'>
                            <View className='flex flex-row items-center'>
                                <View>
                                    <Text className='text-xs'>Intake</Text>
                                    <Text className='text-xs text-black font-[700] -mt-0.5'>18,950 ml</Text>
                                </View>
                            </View>
                        ...
                        <View className="flex justify-center items-start align-middle">
                            <Text className='text-xs'>Recommended</Text>
                            <Text className='text-xs text-black font-[700] -mt-0.5' style={{ textAlign: 'right', width: 82 }}>1,000 ml</Text>
                        </View>
                    </View>
        ...
        <Background>
            <View style={{ flex: 1 }}>
                <View style={{ flexDirection: "row", marginTop: 70, marginHorizontal: 24, alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 20, fontWeight: '500', fontFamily: 'Larken', marginHorizontal: 16, flex: 1 }}>{"Track water"}</Text>
                </View>
