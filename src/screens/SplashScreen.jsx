  ...
  return (
    <View className={`bg-[#FFFCFB] dark:bg-black h-screen `}>
      ...
      <View className="flex h-full justify-between w-full relative z-10 py-20 pb-[60px] items-center">
        <Image
          resizeMode="contain"
          source={require('../assets/app_img/logo.png')}
          className="mt-1 w-[238px] h-[74px]"
        />
        <View className="text-center mx-auto w-full flex flex-col">
          <View className="text-center mx-auto w-[280px] flex flex-col gap-y-[8px]">
            <TouchableOpacity
              onPress={() => navigation.navigate('WhatYourName')}
              className="bg-[#FF9950] w-[278px] h-[70px] mx-auto justify-center text-center rounded-[16px]">
              <Text
                style={{
                  fontWeight: Platform.OS === 'android' ? '400' : '700',
                  fontFamily:
                    Platform.OS === 'android' ? 'Larken-Bold' : 'Larken-Bold',
                }}
            ...
            <TouchableOpacity
              ...
              className="bg-[#FFFFFF] w-[278px] h-[70px] mx-auto text-center justify-center rounded-[16px]">
              <Text
                style={{
                  fontWeight: Platform.OS === 'android' ? '400' : '700',
                  fontFamily:
          ...
          <View className="text-center mt-[24px]">
            <Text className="text-white text-center leading-[28.8px] text-[24px] font-[400]">
              Intermittent Fasting{' '}
            </Text>
            <Text className="text-white text-center text-[24px] leading-[28.8px] font-[700]">
              Made Simple
            </Text>
          </View>
        </View>
      ...
      <Image
        ...
        resizeMode="contain"
        source={require('../assets/starterscreen/selfie_girl.png')}
      />
      <LinearGradient
        start={{x: 0, y: 0}}
        end={{x: 0, y: 1}}
        colors={['rgba(255, 255, 255, 0)', 'rgba(255, 153, 80, 1)']}
        style={{
          position: 'absolute',
          bottom: 0,
          left: 0,
